# %% [markdown]
# # 01 — Data Ingestion
# Load documents from text, CSV, PDF, JSON, web, SQL, S3, and Git sources,
# then apply cleaning + metadata enrichment.
...
# %%
# Text
text_docs = load_documents([{"type": "text", "path": "data/drake_lyrics.txt"}])
print(text_docs[0].page_content[:300])

# %%
# CSV
csv_docs = load_documents([{
    "type": "csv", "path": "data/arxiv_data.csv",
...
# %%
# PDF
pdf_docs = load_documents([{"type": "pdf", "path": "data/ENGINEERING/10030015.pdf"}])
...
json_docs = load_documents([{
    "type": "json", "path": "data/drake_data.json",
    "jq_schema": ".[] | .lyrics", "text_content": False,
}])
